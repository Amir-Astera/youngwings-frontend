...
export function PostPage({ onBack, postData, onPostUpdate }: PostPageProps) {
  ...
  const handleAddComment = () => {
    ...
    const authorName = isAnonymous ? "Аноним" : `${firstName} ${lastName.charAt(0)}.`;
    const newCommentObj = {
      ...
      <article className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
        ...
        <div className="p-5 pb-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            {postData?.excerpt || "Эксперты прогнозируют революционные изменения в технологической индустрии. Искусственный интеллект становится основным драйвером инноваций во всех сферах жизни."}
          </p>
        </div>
          ...
          <div className="border-t border-gray-100 px-5 py-4 bg-gray-50/50">
            ...
            <div className="mb-4 space-y-3">
              ...
              <Textarea
                ...
                rows={2}
              />
              <Button size="sm" className="w-full" onClick={handleAddComment}>Отправить</Button>
            </div>
