...
import { Menu, X, Home, Calendar, Languages, Info, Phone } from "lucide-react";
...
export function MobileMenu({ currentPage, onPageChange }: MobileMenuProps) {
  ...
  return (
    <>
      ...
      <div className="lg:hidden bg-background text-foreground border-b border-border sticky top-14 z-30 overflow-hidden">
        <div className="flex items-center gap-2 px-4 overflow-x-auto scrollbar-hide py-2" style={{ WebkitOverflowScrolling: 'touch' }}>
          ...
          <Button
            ...
            className="flex-shrink-0 gap-2 border border-border h-9"
          >
      ...
      {isOpen && (
        <>
          ...
          {/* Menu Panel */}
          <div className="fixed inset-y-0 left-0 w-72 bg-background text-foreground z-50 lg:hidden shadow-xl overflow-y-auto">
            <div className="p-4">
