...
export function ExhibitionsPage() {
  ...
  const locations = Array.from(new Set(exhibitions.map(e => e.location)));

  // Filter exhibitions
  const filteredExhibitions = exhibitions.filter(exhibition => {
    const statusMatch = statusFilter === "all" || 
                       (statusFilter === "upcoming" && exhibition.status === "upcoming") ||
                       (statusFilter === "completed" && exhibition.status === "completed");
    const locationMatch = locationFilter === "all" || exhibition.location === locationFilter;
            ...
            <div className="p-5">
              ...
              <div className="md:hidden space-y-4">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  <span>{exhibition.date} {exhibition.month}, {exhibition.time.split(' - ')[0]}</span>
                </div>
                    ...
                    <PopoverContent className="w-48 p-2" align="end">
                      <div className="flex flex-col gap-1">
                        <Button
                          ...
                          onClick={() => handleShare("whatsapp", exhibition.title)}
                        >
                        ...
                        <Button
                          ...
                          size="sm"
                          className="w-full h-9 justify-start gap-2"
                          onClick={() => handleShare("instagram", exhibition.title)}
                        >
                          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <Button
                          ...
                          size="sm"
                          className="w-full h-9 justify-start gap-2"
                          onClick={() => handleShare("twitter", exhibition.title)}
                        >
                        ...
                        <Button
                          ...
                          size="sm"
                          className="w-full h-9 justify-start gap-2"
                          onClick={() => handleShare("facebook", exhibition.title)}
                        >
                        ...
                        <Button
                          ...
                          size="sm"
                          className="w-full h-9 justify-start gap-2"
                          onClick={() => handleShare("telegram", exhibition.title)}
                        >
                          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <Button
                          ...
                          size="sm"
                          className="w-full h-9 justify-start gap-2"
                          onClick={() => handleShare("tiktok", exhibition.title)}
                        >
                          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <Button
                          ...
                          size="sm"
                          className="w-full h-9 justify-start gap-2"
                          onClick={() => handleShare("threads", exhibition.title)}
                        >
                          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <Button
                          ...
                          size="sm"
                          className="w-full h-9 justify-start gap-2"
                          onClick={() => handleShare("copy", exhibition.title)}
                        >
                ...
                <div>
                  ...
                  <div className="flex items-center justify-end">
                    <Button size="sm" className="gap-1.5 bg-blue-600 hover:bg-blue-700 h-8 px-3 text-sm">
                      Регистрация
