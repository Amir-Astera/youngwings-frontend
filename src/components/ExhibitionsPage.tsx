                        ...
                        <PopoverContent className="w-48 p-2" align="end">
                          <div className="flex flex-col gap-1">
                            <Button
                              ...
                              onClick={() => handleShare("whatsapp", title)}
                            >
                            ...
                            <Button
                              ...
                              size="sm"
                              className="w-full h-9 justify-start gap-2"
                              onClick={() => handleShare("instagram", title)}
                            >
                              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <Button
                              ...
                              size="sm"
                              className="w-full h-9 justify-start gap-2"
                              onClick={() => handleShare("telegram", title)}
                            >
                              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <Button
                              ...
                              size="sm"
                              className="w-full h-9 justify-start gap-2"
                              onClick={() => handleShare("tiktok", title)}
                            >
                              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <Button
                              ...
                              size="sm"
                              className="w-full h-9 justify-start gap-2"
                              onClick={() => handleShare("threads", title)}
                            >
                              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <Button
                              ...
                              size="sm"
                              className="w-full h-9 justify-start gap-2"
                              onClick={() => handleShare("copy", title)}
                            >
