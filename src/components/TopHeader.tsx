...
export function TopHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 border-b border-border bg-background text-foreground backdrop-blur supports-[backdrop-filter]:bg-background/80 transition-colors">
