    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="mt-[104px] lg:mt-14">
        <main className="mx-auto lg:py-8 py-2">
          <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr_320px] gap-5 lg:gap-12 max-w-[1400px] mx-auto px-4 sm:px-8">
            ...
            <div className="min-h-[calc(100vh-10rem)]">
              ...
              {!viewingPost && currentPage === "home" && (
                <div className="space-y-4 sm:space-y-6 lg:pt-6 pt-1">
